export const EmptyHeartSVG = () => {
    return (
        <svg
            className="heart-svg empty-heart"
...
export const FullHeartSVG = () => {
    return (
        <svg
            className="heart-svg full-heart"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24">
...
export const PlusSignSVG = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="plus-sign-svg">
